...
/** Classe Voyage (Graphe) du package sae de la SAE S2.02 exploitation algorithmique d'un problème  */
public class Voyage {
    ...
    /** Methode static prenant un hashset de pays en argument, représentant les pays non traités de l'algorithme et retourne un int de durée la plus courte */
    ...
    /** Methode static prenant un pays, un int et un autre pays en argument, permetant de calculer la durée minimal entre chacun d'eux (necessaires pour l'algorithme)  */
    ...
    /** Methode static prenant un voyage et un pays en argument, grâce à l'utilisation de deux HashSet nous pourrons produire des valeurs tampons des pays traites et non traites
    ...
    public static Voyage calculerTrajetPlusCourt(Voyage voyage, Pays p) {
        //Non application de la duree de quarantaine pour le pays de départ
        p.setQuarantaine(0);
